...
function Button({ children, className, ...props }) {
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground transition hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-primary/40",
        className
      )}
      {...props}
    >
      ...
      <div className="mb-6 flex items-end justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Direct from verified owners across Lagos.
          </p>
        </div>
